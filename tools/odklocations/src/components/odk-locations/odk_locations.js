/* @ts-self-types="./odk_locations.d.ts" */
 ...
 * @returns {string}
 */
export function convert_to_entities(rows_json, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.convert_to_entities(retptr, ptr0, len0, ptr1, len1);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('odk_locations_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
