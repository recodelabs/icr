...
<sub>`v0.1.0 · Last modified Sep 1, 2026 at 3:46 PM EDT`</sub>
...
Think of each campaign round as a deposit. The registry holds five kinds of record, and each one gets richer with every round.
