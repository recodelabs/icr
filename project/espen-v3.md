...
| Supervision / CareTeam | ◑ deferred | ✅ first slice: `ICRCareTeam` + `ICRTeamRoleCS` + `oversees-area`; lightweight `ICRSupervisionReport`; examples |
| Dose-pole band | ◑ free text | ✅ `dose-pole-band` extension |
