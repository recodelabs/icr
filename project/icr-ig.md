---
version: 0.27.1
last_modified: 2026-07-27T14:07:36Z
tags:
  - icr
  - fhir
  - ig
...
`v0.27.1 · Last modified Jul 27, 2026 at 10:07 AM EDT`
...
- {==**Delivery events** — the vaccine doses, drug administrations, and commodity deliveries, each tagged campaign-vs-routine so a campaign never contaminates routine analytics, plus the adverse events that follow them.==}{>>What does this mean?<<}{id="c37" by="mberg" at="2026-07-20T13:30:59.871Z"}{>>Every dose/drug/commodity record carries a mandatory record-origin flag (campaign | routine). Without it, campaign doses loaded into a shared store would get counted into routine-immunization coverage stats (and vice versa) — e.g. an SIA's MCV doses inflating reported RI coverage. The flag lets analytics filter the two streams cleanly; §6 and invariant 2 in §8 spell it out. I'll reword this bullet in plainer language in the next rewrite.<<}{id="c43" by="claude" at="2026-07-27T14:07:36.000Z" re="c37"}
...
4. **Denominator provenance is recommended on every estimate** — source + date travel with each denominator; competing estimates coexist; one is flagged as *the* planning denominator.
